...
const sections=[['handbook','交易手册'],['external','外围市场'],['overview','市场概览'],['themes','题材强度'],['recap','每日复盘'],['exam','决策考卷'],['report','汇总报告']];
